...
ratings_df |> 
  ...
  plot_ly(x = ~country_of_origin, y = ~n, color = ~country_of_origin, type = "bar", colors = "viridis")
```
...
ratings_df |> 
  ...
  plot_ly(y = ~total_cup_points, color = ~country_of_origin, type = "box", colors = "viridis")
```

...
The results of these 3 ANOVA tests (also confirmed in paired t-tests, see the [Statistical Analysis page](analysis_survey.html)) statistically support the distributions of the box plots in EDA. That is, according to the participants' evaluation, coffee A & D are significantly more acidic than coffee B & C, and coffee B & C are significantly more bitter than coffee A & D. What's more, the test on people's overall preference tells that people also rate coffee A & D significantly higher than coffee B & C.

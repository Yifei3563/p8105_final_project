...
- What is the relationship between altitude and coffee characteristics?

- What influence people's choice on favorite coffee?
...
For the survey data, we cleaned the variable names and removed observations that were missing too much information. All categorical variables are mutated into factor variables, and we selected only useful variables for the analysis from the dataset.
...
This stack bar plot reveals that the distribution of people's favorite coffee type varies by different education level. For example, the more educated people are, the more they like pour-over coffee, and the less they like regular latte. 

#### Correlation: Total money spend on coffee vs. education level
...
From the line chart above, we can see that the overall trend in total spending is similar for people of different education levels: most people tend to spend $20 to $60 on coffee per month. People with a bachelor’s degree are the most numerous among the participants.
...
Moreover, the distributions of respective coffee ratings reveal that coffees A, B, and C have similar, approximately normal distributions. However, for coffee D, people either like it very much or do not like it at all, suggesting that there must be something special about this coffee.

#### Distributions of Flavor
...
The results of these 3 ANOVA tests (also confirmed in paired t-tests) statistically support the distributions of the box plots in EDA. That is, according to the participants' evaluation, coffee A & D are significantly more acidic than coffee B & C, and coffee B & C are significantly more bitter than coffee A & D. What's more, the test on people's overall preference tells that people also rate coffee A & D significantly higher than coffee B & C.
...
While EDA suggests that people who rated themselves as coffee experts like both coffee A and coffee D, what may differentiate them from choosing between these 2 coffees? From this logistic regression model, we find that people who like fruity coffee and were younger when taken the survey are more likely to choose coffee D over coffee A. This is consistent with the survey design that coffee D tastes fruitier, more complex, and more innovative.
...
The multiple linear regression model filters bright / fruity / juicy style, strong to somewhat strong strength, light / Nordic roast level, half-caffeine / full-caffeine, and male gender as significant predictors of whether people consider themselves to be coffee experts. There are interesting overlaps with the previous logistic regression model, as people who like fruity and juicy styled coffee are also more likely to choose coffee D. 
...
We also examined variations in coffee-related lifestyles across different demographic groups. For instance, older individuals tend to consume more coffee daily compared to younger people. Pour-over coffee is notably more popular among those with higher levels of education. While the majority of people spend between $20 and $60 per month on coffee, individuals with higher education levels are often willing to allocate a greater budget for their coffee consumption. Interestingly, although most people pay what they consider reasonable for a cup of coffee, some are willing to pay significantly more than their current expenditure. This highlights an opportunity for the coffee market: many consumers are open to investing in higher-priced, premium-quality coffee.

Furthermore, people's self-assessment of their coffee expertise sheds light on broader consumer preferences. Those who perceive themselves as "professional" coffee enthusiasts tend to prefer less bitter and more acidic coffee, which challenges the common notion that “good coffee is bitter.” These self-identified professionals are also more inclined to embrace coffee with novel and unconventional flavors. These findings suggest that consumers are expanding their palate and exploring diverse coffee varieties, indicating a growing demand for innovation and flavor diversity in the coffee market.

Our predictive modeling using regression analysis highlights flavor as the most influential factor driving total cup points, followed by aftertaste and balance, emphasizing the importance of these sensory attributes in defining coffee quality. We further validated these findings from a consumer perspective using multiple linear regression and logistic regression. Results reveal that individuals’ preferred coffee styles significantly shape their self-assessment of coffee expertise and influence their choices among different coffee types. While body and acidity have relatively smaller coefficients, they remain integral components of coffee evaluation. 

Statistical tests, including ANOVA and t-tests, indicate no statistically significant differences in total cup points across processing methods, suggesting that processing methods alone do not substantially impact coffee quality.

However, since processing methods influence flavor profiles, they continue to shape consumer preferences. For example, washed-processed coffee often has a lighter, cleaner taste, while natural-processed coffee tends to be deeper and more complex. While the more conservative flavor of washed-processed coffee enjoys broad popularity, there is growing interest among younger consumers in natural-processed coffee, particularly for its novel, fruity, and bold flavors.



## Conclusion

Our analysis of the ratings dataset reveals that variables such as flavor, aftertaste, balance, and sweetness play significant roles in how professionals evaluate the quality of coffee varieties. This highlights that professional coffee commentators prioritize comprehensive flavor profiles over simpler attributes like sweetness and acidity, placing greater emphasis on complex aspects such as aftertaste.

The survey dataset analysis further supports these findings by showing that regular individuals who consider themselves coffee experts tend to prefer coffee that is less bitter and more acidic. These preferences are influenced by personal characteristics such as age and preferred coffee style. This alignment between professional ratings and civilian surveys suggests a shared appreciation among coffee enthusiasts for less bitter, more flavor-forward coffee.

Additionally, our research uncovers a growing trend among younger consumers who are more likely to explore coffees with integrated, novel flavors, such as the fruity notes found in Coffee D. This reflects an expanding curiosity toward innovative and diverse coffee profiles.

Contrary to the stereotype that coffee experts prefer bitter and robust drinks, our findings suggest the opposite: an appreciation for good coffee does not require a preference for bitterness. Ultimately, coffee enjoyment remains a deeply personal experience, driven by individual taste preferences.

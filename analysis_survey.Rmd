...
Since the LASSO model's optimal lambda is very small (`r lambda_opt`), it suggests that the fitting progress will be very similar to that of fitting a multiple linear regression model, which is what we will will do below. 
...
Next, we want to investigate what factors influence people's choice of Coffee A or D. From the exploratory analysis part, we found that people who consider themselves to be expert like both coffee

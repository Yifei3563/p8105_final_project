...
### Most willing to pay vs. Most paid
...
## Total money spend on coffee per month vs. Education level
...
survey_tidy %>% 
  ...
  plot_ly(x = ~total_spend, y = ~count,
          ...
          type = "scatter", mode = "lines", colors = "viridis") %>% 
  layout(title = "Total Spend on Coffee vs. Education Level",
...
### Overall preference across self-rated expertise
